...
bool Context::Init() {
    ...
    float vertices[] = {
        0.5f, 0.5f, 0.0f, 1.0f, 1.0f, 1.0f, // top right, red
        0.5f, -0.5f, 0.0f, 0.5f, 0.5f, 0.0f, // bottom right, green
        -0.5f, -0.5f, 0.0f, 1.0f, 1.0f, 1.0f, // bottom left, blue
        -0.5f, 0.5f, 0.0f, 0.0f, 0.5f, 0.5f, // top left, yellow
    };
    ...
    glClearColor(0.5f, 0.4f, 0.3f, 0.4f);
